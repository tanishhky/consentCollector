                ...
                (i = [
                    {
                        ...
                        value: function () {
                            if (this.$ele) {
                                var e = this.uniqueId,
                                    t = "vscomp-wrapper",
                                    i = this.getTooltipAttrText(
                                        this.placeholder,
                                        !0,
                                        !0
                                    ),
                                    o = this.getTooltipAttrText(
                    ...
                    },
                    {
                        ...
                        value: function () {
                            ...
                            if (
                                ...
                                this.multiple &&
                                    (n = '<span class="checkbox-icon"></span>'),
                                this.allowNewOption)
                            ) {
                        ...
                        value: function () {
                            ...
                            var O = function t(O) {
                                ...
                                if (
                                    ...
                                    O.isGroupOption &&
                                        ((C.isGroupOption = !0),
                                        (C.groupIndex = O.groupIndex)),
                                    u && (C.description = h(p(O[a]))),
                                    O.customData &&
                                        (C.customData = O.customData),
                                    i.push(C),
                                    (y += 1),
                                    E)
                                ) {
                        ...
                        value: function () {
                            ...
                            if (o) e = o;
                                ...
                                (e = this.$dropboxContainer.querySelector(
                                    ...
                                    (c.hasClass(e, "disabled") ||
                                        c.hasClass(e, "group-title")) &&
                ...
                (n = [
                    ...
                    },
                    {
                        ...
                        value: function (i, o, s, n) {
                            i &&
                                (o = t.removeArrayEmpty(o.split(" "))).forEach(
                                    function (t) {
                                        (i = e.getElements(i)).forEach(
                                            function (e) {
                                                "add" === n
                ...
                return (
                    ...
                    (o = [
                        ...
                        },
                        {
                            ...
                            value: function () {
                                (this.$scrollableElems = n.getScrollableParents(
                                    this.$ele
                                )),
